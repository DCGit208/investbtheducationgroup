...
$og_url           = "https://invest.btheducationgroup.com/software-engineering.php";
include 'header.php';
?>
  ...
  <div class="hero">
    ...
    <div class="hero-left">
      ...
      <div class="cta-row">
        ...
        <a class="btn" href="#hire-dev-team">Request Proposal</a>
      </div>
      <div class="stats">
...
<section id="nav" class="section">
  ...
  <div class="grid">
    ...
    <a class="card" href="#hire-dev-team">Request Proposal</a>
    <a class="card" href="#kpis">KPIs &amp; DORA</a>
...
<section id="proof" class="section">
  <h2>Proof &amp; Portfolio — Challenges, Solutions, Stacks, Outcomes</h2>
  <div class="grid">
    <div class="card">
      <h3>FinTech — Real-Time Payments</h3>
      <p><strong>Challenge:</strong> Legacy batch settlement and fraud exposure.</p>
      <p><strong>Solution:</strong> Event-driven microservices, idempotent APIs, real-time risk scoring.</p>
      <p><strong>Stack:</strong> Java/Spring, Kafka, PostgreSQL, Redis, Kubernetes, Keycloak, Vault.</p>
      <p><strong>Outcome (KPIs):</strong> p99 latency &lt; 180ms, 99.95% uptime, fraud loss ↓ 38%, ops cost ↓ 27%.</p>
      <p class="muted">Badges: Finance • Payments • Compliance</p>
    </div>
    <div class="card">
      <h3>HealthTech — Telemedicine @ Scale</h3>
      <p><strong>Challenge:</strong> Rural coverage, intermittent networks, sensitive PHI.</p>
      <p><strong>Solution:</strong> Offline-first mobile, secure video, FHIR gateway, audit trails.</p>
      <p><strong>Stack:</strong> Flutter, WebRTC, Node/NestJS, FHIR, PostgreSQL, S3, Terraform, OpenTelemetry.</p>
      <p><strong>Outcome (KPIs):</strong> No-show ↓ 23%, readmission ↓ 12%, claim denials ↓ 9%.</p>
      <p class="muted">Badges: Health • PHI • HIPAA</p>
    </div>
    <div class="card">
      <h3>GovTech — Citizen Identity</h3>
      <p><strong>Challenge:</strong> Fragmented identity &amp; slow onboarding.</p>
      <p><strong>Solution:</strong> OIDC/SAML federation, document verification, scalable consent.</p>
      <p><strong>Stack:</strong> .NET, PostgreSQL, Redis, Keycloak, Kafka, Elastic, AKS.</p>
      <p><strong>Outcome (KPIs):</strong> Onboarding time ↓ 65%, ticket volume ↓ 31%, availability 99.98%.</p>
      <p class="muted">Badges: Government • Identity • Accessibility</p>
    </div>
    <div class="card">
      <h3>Telco — Messaging Platform</h3>
      <p><strong>Challenge:</strong> High-throughput messaging with strict SLAs.</p>
      <p><strong>Solution:</strong> Back-pressure, autoscaling, observability &amp; chaos drills.</p>
      <p><strong>Stack:</strong> Go, NATS, Cassandra, Prometheus/Grafana, Envoy, GKE.</p>
      <p><strong>Outcome (KPIs):</strong> 2M msgs/min @ p95 &lt; 120ms, error budget met for 6 quarters.</p>
      <p class="muted">Badges: Telco • Realtime • SRE</p>
    </div>
    <div class="card">
      <h3>Commerce — Marketplace</h3>
      <p><strong>Challenge:</strong> Multi-vendor scale &amp; fraud spikes.</p>
      <p><strong>Solution:</strong> Search/reco, payments orchestration, antifraud integration.</p>
      <p><strong>Stack:</strong> Node/Next.js, Elastic, Redis, Stripe/Flutterwave, CloudFront.</p>
      <p><strong>Outcome (KPIs):</strong> GMV ↑ 3.1×, chargebacks ↓ 42%, LTV ↑ 18%.</p>
      <p class="muted">Badges: Retail • FinTech • Analytics</p>
    </div>
    <div class="card">
      <h3>Industrial — Predictive Maintenance</h3>
      <p><strong>Challenge:</strong> Downtime losses on distributed equipment.</p>
      <p><strong>Solution:</strong> Edge ingestion, feature store, anomaly detection, alerts.</p>
      <p><strong>Stack:</strong> Rust, MQTT, TimescaleDB, dbt, SageMaker, Grafana.</p>
      <p><strong>Outcome (KPIs):</strong> Unplanned downtime ↓ 37%, maintenance cost ↓ 22%.</p>
      <p class="muted">Badges: Industrial • IoT • ML</p>
    </div>
  </div>
</section>
...
<section id="architecture" class="section">
  ...
  <details class="card"><summary><strong>Architecture Playbooks</strong></summary>
    <p>Microservices vs. modular monolith decision matrix, event-driven patterns, serverless fit, multi-tenant SaaS blueprint, data mesh decision points, reference architectures per domain.</p>
  </details>
</section>
...
<section id="devops" class="section">
  ...
  <div class="grid" style="margin-top:20px">
    <div class="card">
      <h3>SRE &amp; Performance Engineering</h3>
      <p>Golden signals (latency, traffic, errors, saturation), error budgets, autoscaling policies, chaos drills, perf budgets in CI with p95/p99 targets and load baselines.</p>
    </div>
    <div class="card">
      <h3>Developer Experience (DevEx) Platform</h3>
      <p>Scaffolds, golden paths, Backstage catalog, reusable IaC/modules, policy-as-code and paved roads for speed, consistency and lower total cost.</p>
    </div>
  </div>
</section>
...
<section id="security" class="section">
  ...
  <div class="card" style="margin-top:20px;overflow:auto">
    <h3>Compliance Coverage Map</h3>
    <table style="width:100%;border-collapse:collapse;">
      <thead>
        <tr>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">Control Area</th>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">PCI</th>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">HIPAA</th>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">GDPR</th>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">ISO 27001</th>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">SOC 2</th>
        </tr>
      </thead>
      <tbody>
        <tr><td style="padding:8px;">Secure SDLC &amp; Code Review</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr><td style="padding:8px;">Identity &amp; Access (MFA, RBAC, PAM)</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr><td style="padding:8px;">Encryption in transit/at rest</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr><td style="padding:8px;">Logging, Audit &amp; Retention</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr><td style="padding:8px;">Vulnerability &amp; Patch Management</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr><td style="padding:8px;">Incident Response &amp; Breach Notice</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr><td style="padding:8px;">Data Residency &amp; Minimization</td><td>—</td><td>—</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr><td style="padding:8px;">PHI/PII Safeguards &amp; Policies</td><td>—</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr>
      </tbody>
    </table>
    <p class="muted">We integrate SBOMs, signed artifacts, zero-trust APIs, secrets management, and evidence packs for audits.</p>
  </div>
</section>
...
<section id="quality" class="section">
  ...
  <div class="card" style="margin-top:20px">
    <h3>Quality &amp; Risk Governance</h3>
    <p>DoR/DoD definitions, test pyramid (unit/integration/e2e/contract/visual), WCAG 2.2 AA accessibility gates, localization/internationalization, release trains with canary &amp; blue/green, rollback playbooks.</p>
  </div>
</section>
...
<section id="dataai" class="section">
  ...
  <div class="card" style="margin-top:20px">
    <h3>AI/ML &amp; GenAI Build Tracks</h3>
    <p>Traditional ML plus GenAI application engineering (RAG, evaluation harnesses, prompt mgmt, vector stores, guardrails). MLOps with feature stores, model registry, CI/CD for models, drift &amp; fairness monitoring.</p>
  </div>
</section>
...
<section id="packages" class="section">
  ...
  <div class="grid">
    <div class="card">
      <h3>MVP in 90 Days — Starter Build</h3>
      <p><strong>Pods:</strong> 1 product pod (PM, FE, BE, QA, UX, DevOps)</p>
      <p><strong>Sprints:</strong> 6 × 2 weeks</p>
      <p><strong>Deliverables:</strong> Validated scope, design system, working MVP, telemetry</p>
      <p><strong>Acceptance:</strong> DoD met, E2E tests green, p95 &lt; 500ms, A11y WCAG 2.2 AA</p>
      <p><strong>Warranty:</strong> 30 days bug warranty (non-scope defects)</p>
    </div>
    <div class="card">
      <h3>Product Accelerator</h3>
      <p><strong>Pods:</strong> 2 product pods + shared platform/SRE</p>
      <p><strong>Sprints:</strong> 12 × 2 weeks</p>
      <p><strong>Deliverables:</strong> V1.0 features, API platform, CI/CD, observability, playbooks</p>
      <p><strong>Acceptance:</strong> DoR/DoD enforced, p95 &lt; 300ms, error budget policy, SLA draft</p>
      <p><strong>Warranty:</strong> 60 days bug warranty</p>
    </div>
    <div class="card">
      <h3>Platform Modernization</h3>
      <p><strong>Pods:</strong> 1 modernization pod + 1 integration pod + SRE</p>
      <p><strong>Sprints:</strong> 10 × 2 weeks</p>
      <p><strong>Deliverables:</strong> Strangler services, data migration, observability, cost guardrails</p>
      <p><strong>Acceptance:</strong> Zero-downtime cutover plan tested, p95 &lt; 250ms, rollback runbooks</p>
      <p><strong>Warranty:</strong> 60 days bug warranty</p>
    </div>
    <div class="card">
      <h3>Enterprise Transformation</h3>
      <p><strong>Pods:</strong> 3–4 cross-functional pods + platform guilds</p>
      <p><strong>Sprints:</strong> 24 × 2 weeks</p>
      <p><strong>Deliverables:</strong> Domain portfolio, data/AI enablement, security/compliance, SRE</p>
      <p><strong>Acceptance:</strong> Exec KPIs, DORA targets met, perf budgets in CI, compliance evidence</p>
      <p><strong>Warranty:</strong> 90 days bug warranty</p>
    </div>
  </div>
</section>
...
<section id="kpis" class="section">
  <h2>KPIs &amp; DORA — What We Commit To</h2>
  <div class="grid">
    <div class="card"><h3>Lead Time</h3><p>Target bands per package; MVP &lt; 1 day per change (post-MVP), Enterprise &lt; 3 days.</p></div>
    <div class="card"><h3>Deploy Frequency</h3><p>MVP daily, Accelerator 2–5/day, Modernization 1–3/day, Enterprise 1–10/day by domain.</p></div>
    <div class="card"><h3>Change Fail Rate</h3><p>&lt; 10% (MVP), &lt; 8% (Acc/Mod), &lt; 5% (Enterprise) with automated rollback.</p></div>
    <div class="card"><h3>MTTR</h3><p>&lt; 1 hour for high-priority services using runbooks, canary &amp; observability.</p></div>
  </div>
</section>
...
<section id="commercials" class="section">
    ...
    <table style="width:100%;border-collapse:collapse;">
      <thead>
        <tr>
          ...
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">Typical Roles</th>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">Velocity (pts/mo)</th>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">Illustrative Monthly Rate (USD)</th>
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">Typical Scope</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style="padding:8px;">Product Pod</td>
          <td style="padding:8px;">PM, FE, BE, QA, UX, DevOps</td>
          <td style="padding:8px;">120–160</td>
          <td style="padding:8px;">$65k–$95k</td>
          <td style="padding:8px;">New features, UX, integrations</td>
        </tr>
        <tr>
          <td style="padding:8px;">Platform/SRE Pod</td>
          <td style="padding:8px;">Architect, Platform Eng, SRE, SecEng</td>
          <td style="padding:8px;">80–120</td>
          <td style="padding:8px;">$70k–$110k</td>
          <td style="padding:8px;">CI/CD, infra, observability, cost mgmt</td>
        </tr>
        <tr>
          <td style="padding:8px;">Integration Pod</td>
          <td style="padding:8px;">BE, Integrations, QA, PM</td>
          <td style="padding:8px;">100–140</td>
          <td style="padding:8px;">$55k–$85k</td>
          <td style="padding:8px;">APIs, ERP/CRM links, data sync</td>
        </tr>
      </tbody>
    </table>
    <p class="muted">Rates depend on geography, compliance, and SLA. Full finance pack available on request.</p>
  </div>
  ...
  <div class="card" style="overflow:auto">
    ...
    <table style="width:100%;border-collapse:collapse;">
      <thead>
        <tr>
          ...
          <th style="text-align:left;padding:8px;border-bottom:1px solid #ddd;">Residual (Managed Products)</th>
    ...
    <p class="muted">Figures align with the 1:50 leadership model and example multi-contract deployment scenarios.</p>
  </div>
</section>
...
<section id="boundaries" class="section">
  ...
  <div class="grid">
    <a class="card" href="information-technology.php"><h3>Technology &amp; Infrastructure (IT)</h3><p>Ops, ITIL, endpoint/server/network, DBA, collaboration.</p></a>
    <a class="card" href="intelligent-cloud.php"><h3>Intelligent Cloud, Data &amp; AI</h3><p>PaaS, AI/ML platforms, data lakes/warehouses, MLOps scale.</p></a>
    <a class="card" href="cybersecurity.php"><h3>Cybersecurity</h3><p>SSDLC governance, SOC/MDR, pentesting, compliance programs.</p></a>
  </div>
</section>
...
<!-- Hire Dev Team (Client Proposal Form) -->
<section id="hire-dev-team" class="section">
  <h2>Request a Software Engineering Proposal</h2>
  <p style="color:#6b7280;max-width:900px;margin:0 auto 30px;text-align:center;">
    Tell us about your product or platform. We’ll scope, propose pods, timelines, and commercials aligned to your compliance and reliability needs.
  </p>
  ...
  <form method="post" action="send-mail.php" class="application-form">
    ...
    <div class="form-row">
      <div class="field">
        ...
        <select name="project_type" required>
          <option value="">Select...</option>
          <option>MVP / New Product</option>
          <option>Scale-Up / Feature Expansion</option>
          <option>Platform Modernization</option>
          <option>System Integration / APIs</option>
          <option>Mobile Apps (iOS/Android/Flutter)</option>
          <option>Data Platform / AI</option>
          <option>Managed Product (SLA/SLO)</option>
        </select>
      </div>
      <div class="field">
    ...
    <div class="form-row">
      ...
      <div class="field">
        ...
        <select name="compliance">
          ...
          <option>ISO 27001 / SOC 2</option>
          <option>PCI DSS</option>
          <option>HIPAA / PHI</option>
          <option>GDPR / Data Residency</option>
    ...
    <div class="field">
      ...
      <textarea name="message" rows="6" placeholder="Briefly describe the problem, users, critical features, target platforms, integrations, and success metrics…"></textarea>
    </div>

    <input type="hidden" name="industry" value="Software &amp; Systems Engineering">
    <input type="hidden" name="source" value="Hire Dev Team • Request Proposal">
...
<section id="faq" class="section">
  ...
  <details class="card"><summary><strong>Build vs. Buy?</strong></summary><p>We use product discovery and architecture playbooks to quantify ROI. We integrate best-in-class platforms where buying wins, and build custom only where it creates durable advantage.</p></details>
  <details class="card"><summary><strong>Who owns the IP?</strong></summary><p>You own the code and artifacts per contract. We reuse internal templates/tooling but your deliverables and environments are dedicated to you.</p></details>
  <details class="card"><summary><strong>Vendor lock-in?</strong></summary><p>Abstraction patterns, portability testing, and multi-cloud capable build pipelines reduce switching cost. Architecture decisions are documented with clear trade-offs.</p></details>
  <details class="card"><summary><strong>What if requirements change?</strong></summary><p>Backlog governance, change control, feature flags, incremental delivery and measurable acceptance criteria keep scope safe without stalling progress.</p></details>
  <details class="card"><summary><strong>Evidence for regulated workloads?</strong></summary><p>Compliance map, audit trails, SBOMs, security test reports, and runbooks are provided; we align to ISO 27001/SOC 2 and sector frameworks like HIPAA/PCI on request.</p></details>
...
<script type="application/ld+json">
{
  ...
  "description": "Product discovery, architecture, cloud-native delivery, DevOps/SRE, secure SDLC, data/AI and multi-platform apps via 1:50 pods.",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Software & Systems Engineering", "item": "<?php echo htmlspecialchars($og_url, ENT_QUOTES); ?>"}
  ]
}
</script>
